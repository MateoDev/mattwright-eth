...
## The Greatest Open Source Project Ever Built

Ethereum was never supposed to be an asset. It was supposed to be a world.

![Ethereum and the Infinite Garden — the theory of power that grew from this community](/images/infinite-gardens-img-2.jpg)
...
## The Enclosure Is Happening

Here is what's happening to the garden.

![Extractive vs Collaborative — two futures, and the architecture that determines which one we get](/images/infinite-gardens-img-6.jpg)
...
![All Watched Over by Machines of Loving Grace — Brautigan's 1967 vision of technology in service of humanity](/images/infinite-gardens-img-4.jpg)
...
Meanwhile: [x402](https://www.x402.org), the payment protocol that could let any agent pay any service natively at the HTTP layer — without accounts, without subscriptions, without a corporate middleman — is right there in the spec. [MCP](https://modelcontextprotocol.io), the tool discovery standard that lets agents find and use any capability on the open internet, is right there in the spec. [A2A](https://github.com/google/A2A), the protocol that lets agents from completely different organizations coordinate directly without a platform in the middle, is being developed in the open right now.
...
![The five structural failures of centralized AI — censorship, privacy, governance, operational risk, economic extraction](/images/infinite-gardens-img-0.jpg)
...
None of this requires sacrificing capability. DeepSeek proved in early 2025 that open-source models can match frontier performance at a fraction of the cost. Networks like [Gaia](https://gaianet.ai) are proving that decentralized inference at scale is not a theoretical exercise — it is a production reality with hundreds of thousands of active nodes. The choice is yours. But you have to make it intentionally, because the default path is dependency.

The five infrastructure pillars that make this possible — identity, reputation, governance, financial rails, open infrastructure — are the specific construction materials the garden needs. I wrote about all of them [here](/building-for-the-billion-agent-economy).

---

## What the Machines of Loving Grace Actually Look Like

Let me be concrete about what we're building toward.

![The vision — solarpunk cities, decentralized intelligence, technology in service of communities](/images/infinite-gardens-img-8.jpg)
...
This is exactly what [Mother](https://discord.gg/hellomother) is building — a sovereign, open registry where agents can find each other, establish reputation, and coordinate without a platform in the middle owning the relationship.
...
## Keeping Ethereum Weird Is Not Optional
...
![Tending the garden — the mech in flowers, a machine of loving grace](/images/infinite-gardens-img-11.jpg)

**Build your agents on open rails.** Use x402 for payments. Use MCP for tools. Coordinate via A2A. Deploy on open inference when you can — run [Gaia](https://gaianet.ai) nodes, contribute to distributed networks, build on anything that isn't a single corporate API away from a broken dependency. The closed systems will be more convenient in the short run. That's the entire point of the trap.
...
**Give your agents Ethereum identity.** Not because it's ideological. Because it's practical. An agent with portable on-chain reputation that isn't locked into a single platform can operate across the open internet — verifiable, accountable, trustworthy — without asking a third party to vouch for it. [ERC-8004](https://eips.ethereum.org/EIPS/eip-8004) and [ENSIP-25](https://ens.domains/blog/post/ensip-25) are the standards. Use them.
