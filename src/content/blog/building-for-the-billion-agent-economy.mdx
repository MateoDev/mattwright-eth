...
![Figure 04 - Agents All the Way Down: from human orchestrator to specialist fleet to backend infrastructure](/images/agents-all-the-way-down-figure04.png)
...
![The Agentic Bazaar - a vast open marketplace where agents discover, hire, and transact with each other at machine speed](/images/agentic-bazaar-hero.jpg)
...
![LM Arena — community voting on model quality. The precursor to on-chain model governance in the agent economy.](/images/lmarena-model-voting.png)
...
![Figure 06 — Governance: a mock proposal to incentivize finance-specialized Gaia nodes, with live vote distribution and top node rankings](/images/governance-proposal-figure06.png)
...
![Figure 05 - Financial Rails: Identity → Payment → Markets, and the agent job cycle end to end](/images/financial-rails-figure05.png)
...
| Agent | Model | Hosting | Scope | Trust Level |
|---|---|---|---|---|
| Primary Hub (Papi) | Claude Sonnet | XO Cloud | Orchestration, scheduling, context routing | Full autonomy |
| Gaia Node ×5 | Llama 3.1 8B | Self-hosted | Domain RAG, local inference, specialized context | Full autonomy |
| Engineering Swarm | Codex / Claude | XO Cloud | Builds, PRs, deployments, repo management | Human approval on merge |
| Trading Agent (evmchad) | Fine-tuned | Isolated instance | Market signals, position sizing, execution | Human approval above threshold |
| Comms Agent | GPT-4o-mini | Edge | Drafting, routing, summarising across channels | Full autonomy on draft |
| Stu (Mac Studio) | Ollama 70B | Local hardware | Private ops, GPU inference, overnight jobs | Full autonomy |
...
![OpenRouter model catalogue — today’s model governance is whatever OpenRouter decides to host. No on-chain vote, no community process, no appeal.](/images/openrouter-models.png)
