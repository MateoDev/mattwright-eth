...
![Web evolution: from read to write to own to act](/images/graphic-1-web-evolution.svg)
...
![The Agentic Bazaar — a composable marketplace running at machine speed](/images/graphic-4-agentic-bazaar.svg)
...
![The orchestrator — coordinating agents across the financial stack](/images/graphic-5-orchestrator.svg)
...
| Agent / Cluster | Platform | Model | Scope | Trust Level |
|---|---|---|---|---|
| Primary Hub | XO (local) | Qwen (local) | Orchestration, context routing | Full autonomy |
| Gaia Nodes (x5) | XO (local) | Qwen (local) | Segregated data domains | Full autonomy |
| Engineering Swarm | XO (hosted) | Claude / Codex | Build tasks, PRs, repo management | Human approval on merge |
| Trading Agent | XO (hosted) | Claude / local | Research, signal generation, execution | Human approval above threshold |
| Comms Agent | XO (hosted) | Claude | Drafting, routing, summarising | Full autonomy on draft |
