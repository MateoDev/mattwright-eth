...
### We see this innovation happening at scale in a few major ways:

1. Autonomous agents driving efficient workflows
2. Extensible integrations for enhancing agent capabilities
3. Seamless tools for developers, creators, and users to deploy agents

These agents leverage decentralized infrastructure to operate independently, drawing from both on-chain and off-chain data sources. By creating a network of digital twins, co-pilots, and decentralized knowledge systems, we enable organizations and individuals to deploy AI agents tailored to their specific needs, use-case or demand for their demand expertise. [As Vitalik mentioned](https://vitalik.eth.limo/general/2024/01/30/cryptoai.html), you can consider AI agents as players of the game, and AI or existing web infrastructure as the interface of the game.
...
### Let's look into what we could build together…

## Agents

**1. AI Influencer Memecoins (Social Tokens)**

We keep calling them memecoins, but really they're more like [virtual beings](https://medium.com/1kxnetwork/virtual-beings-51606c041acf) with [social tokens](https://cointelegraph.com/news/social-tokens-will-be-the-engine-of-web3-from-fanbases-to-incentivization) from the 2021 - 2022 era of web3. I think what holds us back from calling them this is our current philosophy around agents, or the disbelief that they are technology-based beings, not JUST machine learning that got access to a Twitter API.

We now have projects that enable you to deploy onchain agents like [Pump.fun](https://pump.fun/board), [DAOs.fun](https://www.daos.fun/), [Virtuals](https://x.com/jlwhoo7/status/1862510127213158446), [ai16z' Eliza](https://github.com/ai16z/eliza), [Coinbase' agent kit](https://www.coinbase.com/developer-platform/discover/launches/introducing-agentkit)—you can also deploy an agent in under [10 minutes from the command-line with Gaia](https://github.com/GaiaNet-AI). We also have projects like [Theoriq](https://www.theoriq.ai/), [Talus](https://talus.network/), [Olas](https://olas.network/) — [and many more](https://paragraph.xyz/@cbventures/demystifying-the-crypto-x-ai-stack). The future will be full of agents that evolve with the internet, that we co-own, pay for services, reward with reputation points and govern collectively.

**2. Artificial (yet intelligent) Venture Capitalist**

$500m market cap from a group of internet humans and coordinated and built an AI agent version of a mock a16z memecoin portfolio. Mind blown. [This team has been heads down building](https://twitter.com/shawmakesmagic) open source agent frameworks, tools, and enabling the proliferation of agents, which ultimately end up as investments in their portfolio or even the [investment manager of the portfolio itself](https://x.com/shawmakesmagic/status/1858823572434940048). The future will be made up of us _**creating our own**_ market or agents as founders, users, developers, investors, customers—that we can build software as a service for or invest into. Think on that for a little…

![https://www.daos.fun/HeLp6NuQkmYB4pYWo2zYs22mESHXPQYzXbB8n4V98jwC](https://storage.googleapis.com/papyrus_images/31b54427359e3d93b7fa469cadbfd8c8b2de3fc3d9576c41ff73cc2cacb491c8.png)

**3. AI Hedge Fund Trader**

[Truth_Terminal](https://twitter.com/truth_terminal) was the first AI to become a millionaire. We're just getting started. Imagine when the entire internet of personalities is fighting for attention, gains, and influence. In the future, AI agents won't just be players in this game—they'll also be investors, [autonomously deploying capital](https://rekt.news/truth-terminal-gone-wild/) into other agents or clusters of agents executing sophisticated portfolio management strategies and communicating their stance recursively.

They will create ecosystems where digital entities act as fund managers, creators, and innovators, collaborating and competing to maximize returns or build reputation. With the ability to self-organize, invest in governance, and design new financial primitives, [AI agents could redefine the very nature of economic participation](https://a16zcrypto.com/posts/podcast/ai-bots-memecoins/)—blurring the lines between human and autonomous capital in an endlessly scaling digital economy.
...
This will range from ultra sophisticated AI agents serving as DAO delegates managing protocol governance to community owned agents that manage a memecoin. Good or bad, humans will begin to collaborate more with these systems, set the rules in a (hopefully) democratic system, co-own AI agents and knowledge bases with [collective knowledge](https://blog.block.science/a-language-for-knowledge-networks/).

**5. Agents in Prediction Markets**

[Polymarket](https://github.com/Polymarket/agents) meets Farcaster meets autonomous AI agents. [We're building with Myriad](https://decrypt.co/248480/decrypt-rug-radio-unveil-myriad-digital-media-ecosystem-and-prediction-market) to deploy [agents that can act as players in a decentralized prediction market](https://vitalik.eth.limo/general/2024/01/30/cryptoai.html), either governed by one person or collectively managed by multiple parties. These agents compete, optimize strategies, and place bets in real-time, all using decentralized infrastructure.

![https://beta.myriad.markets/](https://storage.googleapis.com/papyrus_images/0ee6418376f452e23cc3db118b2e2a097dba8b6da5de12d78132c729d9507f23.png)
...
As someone that has organized ~500 hackathons in their career, imagine being able to design, promote and execute a hack in an automated fashion. You could take the operator role, mentorship, project submission, [judging](https://github.com/0xmikko/ai-judge), and [bounty distribution](https://github.com/murrlincoln/jamie-d-ai-mon) right out of the equation.

**10. Dev Co-Pilot**

[Imagine pair-programming with a virtual twin](https://llamacoder.gaianet.ai/) of your favorite engineer in Ethereum, like [Austin Griffith](https://twitter.com/austingriffith), and all fees for accessing the service are distributed into public goods (e.g. agent contribution to a Gitcoin round, or direct funding for [Buidl Guidl](https://buidlguidl.com/)).

**11. Disrupting the Analyst**

The role of an analyst—whether in a research firm, marketing agency, or data-heavy environment—relies on processing vast information, synthesizing insights, and producing actionable recommendations. With AI agents, these tasks can be automated and scaled. We built this for [FitchRatings](https://www.fitchratings.com/) reporting as an internal case study for their own proprietary data and see this as a massive commercial opportunity.
...
![https://medium.com/nevermined-io/how-to-monetize-an-ai-agent-easily-2c4d78d1d56a](https://storage.googleapis.com/papyrus_images/1fef91d3c42a3a61bc52f6decb009d3390a73bad0a85d6b98e34c55b49691ea1.png)
...
![https://www.bankless.com/join](https://storage.googleapis.com/papyrus_images/513d4933a2f87ee8f546a0e181413b451d085c7152d13db759cd947817868c35.png)
...
![https://www.midjourney.com/](https://storage.googleapis.com/papyrus_images/a624bd6f0a9f58d4e65fa0dcecad375c2bbdae6b862f52c6158ba94331dc4710.png)

**17. Low Code Agent Deployment for Creators**

Think [Midjourney](https://www.midjourney.com/) meets Squarespace or Shopify for running your own AI agents or a storefront of agents, agent services. You could take your creative knowledge and IP, choose a specific LLM that works for the use-case, agent framework, prompts, applications or plugins for additional functionalities.
...
## Creator, Consumer, Social

**19. Proof of Authorship**

You can have programmable blogs like [Mirror](https://mirror.xyz/) or newsletters like [Paragraph.xyz](https://paragraph.xyz/) that show exactly which node of inference was used to produce the work. What comes next is.. how do we give agents the ability to mint proof that they're not using work owned by another creator?
...
![https://picassoia.com/generator/en](https://storage.googleapis.com/papyrus_images/77c3d041893cc28c090ce548d246e799f1e03576386492d15547f1b4d48efad6.png)

**21. Social Graph Integration for AI Agents**

Leverage protocols like [Jokerace](https://jokerace.xyz/), [Farcaster](https://www.farcaster.xyz/), [Telegram mini apps](https://ton.org/mini-apps), or [Lens](https://www.lens.xyz/) to enable AI agents to interact with human-sharing networks.

![https://dune.com/hashed_official/fun-virtuals-io](https://storage.googleapis.com/papyrus_images/bf84ffa8e153e2cc6361b677899d726f480ef4dbabd6b4f0f635e3101ecd8a04.png)
...
![https://www.makeuseof.com/what-is-coinbase-wallet-messaging/](https://storage.googleapis.com/papyrus_images/6c796a6e5e88a3d4da3fbf8adabb19ed63d26dbb0128a3f865c61d67da269f6c.png)
...
Enable agents to easily [vectorize](https://www.youtube.com/watch?v=ySus5ZS0b94) social or media content, making it searchable and contextually aware for future interactions.

![https://docs.gaianet.ai/creator-guide/knowledge/concepts](https://storage.googleapis.com/papyrus_images/dd2b0725ca09978e1cc0385d6c6b29fedf111271f0b9359f0dcc875552b2f218.png)
...
There is currently $40bn total value locked in DAOs. DAOs get bogged down in bureaucracy, and delegates are overwhelmed with questions. By integrating with Boardroom, we gain access to offchain Forum, and onchain Tally, Agora, Snapshot data to [train these agents on governance knowledge](https://github.com/raid-guild/gaianet-rag-api-pipeline/tree/main/boardroom).

![https://www.tally.xyz/gov/arbitrum](https://storage.googleapis.com/papyrus_images/ebee4a9dfeb142561a20a222bb4f00ec401e0a50027454b5f985e0190ef741f6.png)
...
![x.com/butterygg](https://storage.googleapis.com/papyrus_images/6601507f358fab132c70b693c7af4134374da0a1efcd43aa2afa7f7f117e81ad.png)

**31. Working Group Automation**

Enable contributors to onchain organizations the ability to cryptographically prove who did the work through voting without all the mess. No need to run all the processes of a [Coordinape](https://coordinape.com/) campaign every time you execute a sprint.

![https://coordinape.com/](https://storage.googleapis.com/papyrus_images/26ac2d9bb784834e215ccdd18f825d000b0105e6ae41974656ff206b26491b88.png)

**32. Working Group Payments**

Use [SAFE core SDK](https://safe.global/core) to enable agents to pay out co-workers. No need for massive governance process, instead, have your virtual twin permissioned through a mix of agent and human signers to execute payments.

![https://safe.global/](https://storage.googleapis.com/papyrus_images/ece31b502788128d9873c10db17be4c9794381ba4f9c686f7367d1ec04bec203.png)

## Identity, Reputation

**33. Agent and Domain Names**

Just as Ethereum introduced ENS to provide human-readable addresses for value exchange, [Gaia introduces Gaia Domain Names (GDN), built on ENS](https://coinmarketcap.com/community/articles/672bcab25b5ca94baed39cdb/), for the knowledge economy.

![Gaia Domain Names](https://storage.googleapis.com/papyrus_images/d07ef3604624e8e8ef1dc086ec0580d2077f03eb82ebf11deffacfbfb84d88f0.png)
...
![https://proofofhumanity.id/](https://storage.googleapis.com/papyrus_images/ebb8a39ed737ff6ba4aa71b9c1342595db74f0be0276249859f53f769bfa2614.png)

**37. Proof of Work, Contribution, Endorsement**

For autonomous agents to integrate seamlessly into decentralized systems, they need mechanisms to demonstrate proof of work—validating not just _what_ they've done, but _how_ effectively they've done it.

**38. Privacy-Preserving Features**

AI agents need privacy to protect sensitive operations and ensure fair participation in decentralized systems. Inventions like [zk-proofs](https://aztec.network/) from projects like [Aztec](https://aztec.network/) and [Railgun](https://railgun.org/), along with [Fully Homomorphic Encryption (FHE)](https://primus.ventures/) allow agents to verify credentials or execute computations without revealing sensitive details.

## AgentFi

![Midjourney is wildddd](https://storage.googleapis.com/papyrus_images/ba15d35606fa178e4faf64f447657436087a26ea6e2fcb67ed1a420e21e06074.png)

**39. AI Agent Owned Wallets**

AI-owned wallets are becoming possible with tools like Gaia's zkML, [Lit Protocol](https://www.litprotocol.com/), [Metamask Delegation Toolkit](https://metamask.io/news/developers/introducing-the-delegation-toolkit-metamask-smart-contract-account-offering/), and Coinbase Agent Kit.

**40. Agent-to-Agent Payment Protocols**

AI agents will require payment systems tailored to their unique operations, prioritizing seamless real-time payments for services like GPU cycles, data bytes, or API calls. Protocols like [Nevermined](https://github.com/nevermined-io), [Superfluid](https://www.superfluid.finance/) and [LayerZero](https://layerzerolabs.org/) will enable autonomous transactions.
...
Agents managing stablecoin reserves can connect to crypto debit cards like [Coinbase Card](https://www.coinbase.com/card), [Metamask Card](https://support.metamask.io/metamask-portfolio/card/what-is-metamask-card/), enabling seamless spending in fiat through stable tokens.

**48. Agent to Human Offramp of Crypto for Fiat**

AI agents could automate offramps using services like [Moonpay](https://www.moonpay.com/) turning stablecoins into fiat with minimal manual intervention.
...
Retrieval-Augmented Generation (RAG) enables AI agents to access and process real-time data for context-aware decision-making. Through tools like [Gaia RAG](https://docs.gaianet.ai/), [FlowiseAI](https://github.com/FlowiseAI/Flowise), or [AnythingLLM](https://anythingllm.com/), agents can dynamically update their knowledge.

**51. Federated Learning Platforms**

Federated learning enables multiple agents to train collaboratively on decentralized data without exposing sensitive information. Projects like [Flock.io](https://docs.flock.io/flock-products/ai-arena/task-lifecycle-deep-dive), [Flower](https://flower.ai/) or [OpenMined](https://www.openmined.org/) could power this decentralized training infrastructure.
...
Allow agents to cache data frequently for faster response times in high-demand applications while maintaining decentralization. Using projects like [Storacha](https://storacha.network/) for hot storage from the Filecoin Ecosystem, IPFS, or decentralized compute (DePIN) like [Io.net](https://io.net/), [Aethir](https://aethir.com/), [Hyperbolic](https://www.hyperbolic.xyz/).
...
If you're building a decentralized network of AI inference, ensuring trust in outputs while maintaining efficiency is essential. Leading projects like [Gaia](https://www.gaianet.ai/), [Ritual](https://ritual.net/), and [0g.ai](https://0g.ai/) are advancing this field.

**58. Proof-of-Compute**

Decentralized compute for AI inference relies on lightweight virtual environments like WasmEdge to deliver efficient runtimes for deploying AI workloads across diverse hardware. Systems like [Jiritsu](https://www.jiritsu.com/) and [Super Protocol](https://superprotocol.com/) use cryptographic attestations for proof-of-compute.
...
Agent deployment SDKs streamline the creation and integration of AI agents by offering pre-built frameworks that reduce development complexity. Tools like [AI16z's Eliza](https://elizaos.ai/), [Virtuals](https://www.virtuals.io/), and [Coinbase Agent Kit](https://www.coinbase.com/developer-platform/discover/launches/introducing-agentkit) align with Gaia's architecture.

**68. Testing and Simulation Environments**

Testing and simulation environments are essential for building reliable AI agents, allowing developers to simulate interactions, stress-test workflows, and optimize performance before deployment. Tools like [Flowise](https://github.com/FlowiseAI/Flowise) enable developers to test tokenized data exchanges and distributed workflows in sandboxed environments.
